...
# Date: 23/6/22
# Description: Functions and classes for MainVision.py that perform 
...
##
##    file = open(r'C:\Users\Gustavs PC\OneDrive\Skrivebord\CDIOVision\ranksuit.txt', 'r')
...
##        file.close()
    ...
    #Send name of card to txt.file if requested by arduino
    #if readline == 'ready':
    if rank_name != 'Unknown' and suit_name != 'Unknown':
        file = open(r'C:\Users\Gustavs PC\OneDrive\Skrivebord\CDIOVision\ranksuit.txt', 'w')
